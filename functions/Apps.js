module.exports = {
    ...
    /**
     * Registers slash commands to all servers available to the bot
     * @returns
     */
    async execute() {
        ...
        const commands = [
            new SlashCommandBuilder()
                ...
                .addStringOption((option) =>
                    option.setName("song").setDescription("Title or song URL.").setRequired(true)
                ),
            ...
            new SlashCommandBuilder() // profile user commands
                .setName("profile")
                .setDescription(
                    "Command used to check your or others profile status and update: picture, embed etc."
                )
                    ...
                    command
                        ...
                        .addStringOption((option) =>
                            option
                                .setName("link")
                                .setDescription(
                                    "Link to the photo you want to update (has to end with .png|.jpg|.gif)"
                                )
                                .setRequired(false)
                        )
                        .addBooleanOption((option) =>
        ...
        await rest
            .put(Routes.applicationCommands(process.env.USER_BOT), { body: commands })
