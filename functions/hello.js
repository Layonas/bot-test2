...
module.exports ={
    ...
    execute(msg){
        ...
        if(msg.content.match(/nig?g[ersia]+|negra[is]+|nibba/gi)) return msg.reply('https://cdn.discordapp.com/attachments/543849764219781131/930823618726854726/racist_level.png');
